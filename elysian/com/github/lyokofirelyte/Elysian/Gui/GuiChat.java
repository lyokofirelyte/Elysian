...
public class GuiChat extends DivGui {
	...
	public void actionPerformed(Player p){
		...
		case 0:
			...
			main.invManager.displayGui(p, new GuiColourSelection(main, "global_color", this));
			break;
			
		case 1:
			
			main.invManager.displayGui(p, new GuiColourSelection(main, "pm_color", this));
			break;
			
		case 2:
			
			main.invManager.displayGui(p, new GuiColourSelection(main, "alliance_color", this));
			break;
